...
This is a project that I create following the tutorial on youtube [Curso Spring][def] to learn Spring. In this project I create a Dynamic Web Page to manage a database, do CRUD operations on it. So it use Spring and Hibernate. It's runnig over Java 1.8.
Spring configures in spring-crud-servlet.xml the session factory and transacition manager for Hibernate. Also with C3P0 dependecy configure a connection pool for the database.
